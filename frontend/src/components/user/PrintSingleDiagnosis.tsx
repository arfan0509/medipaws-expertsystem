              ...
              <div class="section">
                ...
                <div class="content-box">
                  ...
                  ${
                    diagnosisData.hasil_diagnosis.belief
                      ? `<div class="belief-info">
                          <p><strong>Persentase kemungkinan:</strong> ${formatNumber(
                            diagnosisData.hasil_diagnosis.belief
                          )}%</p>
                  ...
                  <p><strong>Deskripsi:</strong> ${
                    diagnosisData.hasil_diagnosis.deskripsi || "Tidak tersedia"
                  }</p>
              ...
              ${
                ...
                diagnosisData.hasil_diagnosis.kemungkinan_penyakit_lain.length >
                  ...
                  ? `<div class="section ${
                      ...
                      <div class="section-title">Kemungkinan Penyakit Lain (${
                        diagnosisData.hasil_diagnosis.kemungkinan_penyakit_lain
                          .length
                      })</div>
                      <div class="content-box">
