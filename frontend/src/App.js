...
// Komponen MainLayout menggunakan useLocation untuk menentukan apakah Footer perlu ditampilkan
const MainLayout = () => {
    const location = useLocation();
    // Daftar route admin yang tidak memerlukan Footer
    const adminRoutes = new Set([
        ...
        "/data-gejala",
        "/data-relasi-gejala",
        "/riwayatdiagnosis-admin",
    ]);
    const showFooter = !adminRoutes.has(location.pathname);
    return (_jsxs("div", { className: "flex flex-col min-h-screen", children: [_jsx("div", { className: "flex-grow", children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(LandingPage, {}) }), _jsx(Route, { path: "/login", element: _jsx(LoginPage, {}) }), _jsx(Route, { path: "/admin-login", element: _jsx(LoginAdminPage, {}) }), _jsx(Route, { path: "/pasien-login", element: _jsx(LoginPasienPage, {}) }), _jsx(Route, { path: "/pasien-register", element: _jsx(RegisterPasienPage, {}) }), _jsx(Route, { path: "/sistem-pakar", element: _jsx(PrivateRoutePasien, { children: _jsx(SistemPakarPage, {}) }) }), _jsx(Route, { path: "/akun-saya", element: _jsx(PrivateRoutePasien, { children: _jsx(ProfilePage, {}) }) }), _jsx(Route, { path: "/riwayat-diagnosis", element: _jsx(PrivateRoutePasien, { children: _jsx(RiwayatDiagnosisPage, {}) }) }), _jsx(Route, { path: "/admin-dashboard", element: _jsx(PrivateRouteAdmin, { children: _jsx(AdminSidebar, { children: _jsx(Dashboard, {}) }) }) }), _jsx(Route, { path: "/data-penyakit-dan-solusi", element: _jsx(PrivateRouteAdmin, { children: _jsx(AdminSidebar, { children: _jsx(DataPenyakitDanSolusi, {}) }) }) }), _jsx(Route, { path: "/data-gejala", element: _jsx(PrivateRouteAdmin, { children: _jsx(AdminSidebar, { children: _jsx(DataGejala, {}) }) }) }), _jsx(Route, { path: "/data-relasi-gejala", element: _jsx(PrivateRouteAdmin, { children: _jsx(AdminSidebar, { children: _jsx(DataRelasiGejala, {}) }) }) }), _jsx(Route, { path: "/riwayatdiagnosis-admin", element: _jsx(PrivateRouteAdmin, { children: _jsx(AdminSidebar, { children: _jsx(RiwayatDiagnosisAdminPage, {}) }) }) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }) }), showFooter && _jsx(Footer, {})] }));
};
function App() {
    return (_jsx(Router, { children: _jsx(AuthProvider, { children: _jsx(MainLayout, {}) }) }));
}
export default App;
