...
const Dashboard = () => {
    ...
    const fetchDashboardData = async () => {
        try {
            ...
            const parsedDiagnosis = diagnosisRes.data.map((d) => ({
                ...d,
                hasil_diagnosis: typeof d.hasil_diagnosis === "string"
                    ? JSON.parse(d.hasil_diagnosis)
                    : d.hasil_diagnosis,
            }));
            setLatestDiagnoses(parsedDiagnosis
